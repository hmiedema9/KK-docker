...
export CATALINA_OPTS="-agentpath:/dynatrace/agent/lib64/libdtagent.so=name=appserver_KonaKart,server=dtcollector -Xmx1400m -Xms400m -XX:PermSize=256m -XX:MaxPermSize=256m -server -Dsolr.solr.home=${CATALINA_HOME}/solr -Djava.awt.headless=true -Dactivemq.store.dir=${CATALINA_HOME}/mq"
