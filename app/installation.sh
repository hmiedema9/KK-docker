...
/bin/echo 'export CATALINA_OPTS="$CATALINA_OPTS -agentpath:/dynatrace/agent/lib64/libdtagent.so=name=appserver_KonaKart,collector=dtcollector"' > /usr/local/konakart/bin/setenv.sh
